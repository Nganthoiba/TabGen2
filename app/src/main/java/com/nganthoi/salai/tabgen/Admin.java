...
public class Admin extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.create_role) {
            // Handle the camera action
            startActivity(new Intent(getApplicationContext(),CreateRoleActivity.class));
        } else if (id == R.id.create_tabs) {
            startActivity(new Intent(getApplicationContext(),TabActivity.class));
        } else if (id == R.id.create_tabstrips) {
            startActivity(new Intent(getApplicationContext(),TabStripActivity.class));
